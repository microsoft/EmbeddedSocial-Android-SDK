...
import com.microsoft.socialplus.data.storage.ImageStorage;
import com.microsoft.socialplus.data.storage.ImageStorage.StoredImage;
import com.microsoft.socialplus.event.PermissionRequestResultEvent;
import com.microsoft.socialplus.event.dialog.OnDialogItemSelectedEvent;
	...
	private class ImageLoader extends AsyncTask<Uri, Void, Bitmap> {
		...
		protected Bitmap doInBackground(Uri... params) {
			try {
				...
				StoredImage localStoredImage = null;
				try {
