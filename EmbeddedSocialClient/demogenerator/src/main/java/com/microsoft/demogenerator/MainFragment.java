...
import static com.microsoft.embeddedsocial.auth.GoogleAppAuthAuthenticator.AuthenticationMode.SIGN_IN_ONLY;
...
public class MainFragment extends Fragment implements IAuthenticationCallback {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        createUsersButton.setOnClickListener(
                v -> new GoogleAppAuthAuthenticator(this, this, SIGN_IN_ONLY)
    ...
    public String getTopicFromTopicName(String name) {
        GetTopicByNameRequest request = new GetTopicByNameRequest(name, PublisherType.APP);
        String result = null;
        try {
            return request.send();
        } catch (Exception e) {
